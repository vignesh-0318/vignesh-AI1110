...
\author{Gujjala vignesh \\ \normalsize CS22BTECH11025 \\ \large Playing songs from a playlist after shuffling}
...
\begin{document}
	...
	Upon running the Python script, the shuffled song playback functionality is observed. The songs are played in a random order. Users can enjoy a unique listening experience with songs they may not have 		 encountered in a sequential playback.\\
		...
		\item \textbf{Images:}
			\begin{figure}[ht]
				\includegraphics[scale=0.5]{images2/1.png}
				\label{IMG1}
			\end{figure}
			\begin{figure}[ht]
				\includegraphics{images2/2.png}
				\label{IMG2}
			\end{figure}
		\end{enumerate}		
\end{document}
