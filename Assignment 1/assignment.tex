...
\author{Gujjala Vignesh\\CS22BTECH11025}
...
Given, the probability after adding 6 black balls to the box is double the initial probability. 

From the table:
\begin{align}
q&=2 \times p \nonumber \\
\frac{x + 6}{18} &= 2 \times \frac{x}{12} \\
\implies x + 6 &= 3 \times x  \\
\implies 2 \times x &= 6 \\
\implies x &= 3
\end{align}
